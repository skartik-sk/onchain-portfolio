...
import { Github, Linkedin, Twitter, ExternalLink, Briefcase, FolderGit2 } from 'lucide-react'
            ...
            <CardContent className="p-6">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="flex space-x-4 mb-4">
                  {portfolioData.socialMedia.github && (
                    <a href={portfolioData.socialMedia.github} target="_blank" rel="noopener noreferrer">
                  ...
                  {portfolioData.socialMedia.linkedin && (
                    <a href={portfolioData.socialMedia.linkedin} target="_blank" rel="noopener noreferrer">
                  ...
                  {portfolioData.socialMedia.twitter && (
                    <a href={portfolioData.socialMedia.twitter} target="_blank" rel="noopener noreferrer">
              ...
              <CardContent className="p-0">
                ...
                <div className="p-4 space-y-4">
                  {portfolioData.experiences.map((exp, index) => (
                    <div key={index} className="relative pl-6 pb-4 border-l-2 border-pink-500 last:border-l-0">
              ...
              <CardContent className="p-0">
                ...
                <div className="p-4 grid gap-4 md:grid-cols-2">
                  {portfolioData.projects.map((project, index) => (
                    <div key={index} className="bg-gray-800 rounded-lg p-4 hover:shadow-lg transition-shadow duration-300">
